...
export function makeBackup(state){return JSON.stringify({app:'Project Bane',backupVersion:1,exportedAt:new Date().toISOString(),state:normalizeState(state)},null,2)}
